<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyConformation.aspx.cs"
    Inherits="Admin_ModifyConformation" %>
...
<head runat="server">
    ...
    %>
    <link href="CSS/ModifyConformation.css" rel="stylesheet" type="text/css" />
</head>
<body>
        ...
        <ContentTemplate>
            ...
            <div id="body">
                ...
                <div class="status bottom">
                    ...
                    <asp:Label ID="Label2" runat="server" Text="Control Panel / Conformation Page"></asp:Label>
                </div>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                    BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="applicationid"
                    DataSourceID="SqlDataSource1" Height="317px" Width="1004px">
                    <Columns>
                        <asp:BoundField DataField="Email" HeaderText="Email" SortExpression="Email" />
                        <asp:BoundField DataField="Type" HeaderText="Type" SortExpression="Type" />
                        <asp:BoundField DataField="Time" HeaderText="Time" SortExpression="Time" />
                        <asp:BoundField DataField="Date" HeaderText="Date" SortExpression="Date" />
                        <asp:BoundField DataField="applicationid" HeaderText="Applicatio ID" ReadOnly="True"
                            SortExpression="applicationid">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:HyperLinkField DataNavigateUrlFields="confomationfill" HeaderText="Conformation(pdf)"
                            Text="View And Dowanload">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:HyperLinkField>
                    </Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Online_Blood_Donation_SystemConnectionString4 %>"
                    SelectCommand="SELECT * FROM [tblModifyRequest]"></asp:SqlDataSource>
            </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
