<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ambulence_service.aspx.cs"
    Inherits="User_Ambulence_service" %>
        ...
        <ContentTemplate>
            ...
            <div id="body">
                ...
                <div class="status bottom">
                    ...
                    <asp:Label ID="Label2" runat="server" Text="Control Panel / Ambulence Service"></asp:Label>
                </div>
