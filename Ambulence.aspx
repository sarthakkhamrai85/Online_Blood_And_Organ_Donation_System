<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ambulence.aspx.cs" Inherits="Admin_Ambulence" %>
...
<head runat="server">
    ...
    %>
    <link href="CSS/Ambulence.css" rel="stylesheet" type="text/css" />
</head>
<body>
        ...
        <ContentTemplate>
            ...
            <div id="body">
                ...
                <div class="status bottom">
                    ...
                    <asp:Label ID="Label2" runat="server" Text="Control Panel / Ambulence Status"></asp:Label>
                </div>
                <div class="gvContainer">
                    <asp:GridView ID="gvLeader" CssClass="gv" runat="server" AutoGenerateColumns="False"
                        Width="1454px" DataKeyNames="Email" OnRowCancelingEdit="gvLeader_RowCancelingEdit"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="City" ItemStyle-CssClass="gvitem" HeaderStyle-CssClass="gvheader">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtEditCity" CssClass="gvTextbox" runat="server" Text='<%# Bind("City") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <HeaderStyle CssClass="gvheader"></HeaderStyle>
                                <ItemStyle CssClass="gvitem"></ItemStyle>
                            </asp:TemplateField>
